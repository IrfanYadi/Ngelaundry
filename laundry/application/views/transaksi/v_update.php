        ...
        <div class="card-body">
            <form action="<?= base_url('/transaksi/updateData') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal" class="form-control" id="tanggal" value="<?= $queryLndryDetail->tanggal ?>" required autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="pelanggan">Pelanggan</label>
                    <input type="text" name="pelanggan" class="form-control" id="pelanggan" value="<?= $queryLndryDetail->pelanggan ?>" required autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="berat">Berat(kg)</label>
                    <input type="number" name="berat" min="1" class="form-control" id="berat" value="<?= $queryLndryDetail->berat ?>" required autocomplete="off">
                </div>
                <div>
                    <label for="status">Status</label>
                    <select class="form-control" id="status" name="status">
                        <?php
                        if ($queryLndryDetail->status  == "Proses") { ?>
